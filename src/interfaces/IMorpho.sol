...
interface IMorpho {
     ...
     */
    function supply(MarketParams calldata marketParams, uint256 assets, address onBehalfOf, bytes calldata referralCode)
        external;
     ...
     */
    function withdraw(MarketParams calldata marketParams, uint256 assets, address receiver, address owner)
        external
        returns (uint256);
     ...
     */
    function balanceOf(MarketParams calldata marketParams, address account) external view returns (uint256);
     ...
     */
    function convertToAssets(MarketParams calldata marketParams, uint256 shares) external view returns (uint256);
}
